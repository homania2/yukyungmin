          ...
          <div class="col-12"><!-- 그리드시스템중 12가로칼럼 width:100% -->
             ...
             <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">
                <%-- ${user_id2} --%> <!-- jsp에서 자바변수(저장소)를 사용하는 방법 Model로 수신한 $ 변수명 으로 표시. -->
                ...
                <strong><i class="far fa-star mr-1"></i> enabled</strong>
                <p class="text-muted">true</p>
                
                <hr>

                <strong><i class="far fa-address-card mr-1"></i> levels</strong>
